...
CREATE OR REPLACE TABLE DST_COUNTRIES AS
    ...
    from 
    @DST_STAGE/references/countries (pattern=>'.*countries.*[.]json') r,
...
CREATE OR REPLACE TABLE DST_AIRCRAFTS AS
    ...
    from 
    @DST_STAGE/references/aircrafts (pattern=>'.*aircraft.*[.]json') r,
...
from
    @DST_STAGE/references/cities (pattern=>'.*cities.*[.]json') r,
...
select
    ...
    t.value:timeZoneId::String as timeZoneId,
    t.value:UtcOffset::String as UtcOffset
from @DST_STAGE/references/airports (pattern=>'.*airports.*[.]json') r,
...
from @DST_STAGE/references/airlines (pattern=>'.*airlines.*[.]json') r,
...
from
    @DST_STAGE/flightsschedules (pattern=>'.*flightschedules_.*[.]json') r,
LATERAL FLATTEN( INPUT => r.$1 ) t;



SELECT *
FROM @DST_STAGE/flightsstatus/2024-02-07_flightsstatus_LH116_2024-02-01_1.json
;
--CREATE OR REPLACE TABLE DST_FLIGHT_STATUS AS
